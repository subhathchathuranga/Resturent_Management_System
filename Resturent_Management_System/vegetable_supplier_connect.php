...
$vegetable_name = filter_input(INPUT_POST, 'vegetable_name');
...
$date_of_bought = filter_input(INPUT_POST, 'date_of_bought');
	...
	if(!empty($date_of_bought)){
		...
		if(mysqli_connect_error()) {
			...
			$sql = "INSERT INTO vegetable_supplier (supplier_id,supplier_name,vegetable_name,quantity,price,date_of_bought) values ('$supplier_id','$supplier_name','$vegetable_name','$quantity','$price','$date_of_bought')";
			if ($vconn->query($sql)) {
